    ...
    <div className="orders-page">
      ...
      <div className="orders-header">
        ...
        <div>
          ...
          <p>
            Manage all orders received from your buyers.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="orders-main-box">
          ...
          <p>{error}</p>
          <button className="add-produce-order-btn" onClick={fetchOrders}>
            Try Again
          </button>
        </div>
        ...
        <div className="orders-main-box">
          ...
          <p>
            ...
            Once buyers purchase your produce,
